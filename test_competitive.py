...
def test_competitive_system():
    ...
    try:
        ...
        for asin, name, priority in competitors_to_add:
            ...
            print(f"✅ Added competitor: {competitor.competitor_name} ({competitor.asin})")
        ...
        if "error" in analysis_result:
            ...
            print(f"  Main Product: {analysis_result.get('main_product', {}).get('title', 'N/A')[:50]}...")
            print(f"  Competitors analyzed: {group_info.get('competitors_count', 0)}")
            print(f"  Price position: {price_analysis.get('price_position', 'unknown')}")
        ...
        if "error" not in analysis_result:
            ...
            if "error" in positioning_report:
                ...
                print(f"  Executive summary preview: {positioning_report.get('executive_summary', '')[:100]}...")
        ...
        for group in groups:
            ...
            if hasattr(group, 'active_competitors'):
                ...
                for comp in group.active_competitors:
                    print(f"     - {comp.competitor_name} ({comp.asin}) [Priority: {comp.priority}]")
