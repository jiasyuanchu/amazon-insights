...
DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql://amazon_insights:password@localhost:5432/amazon_insights')
DATABASE_URL_REPLICA = os.getenv('DATABASE_URL_REPLICA')  # Read replica URL
SQLITE_FALLBACK = os.getenv('SQLITE_FALLBACK', 'True').lower() == 'true'  # Fallback to SQLite in dev
